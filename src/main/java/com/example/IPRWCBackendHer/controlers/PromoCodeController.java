...
public class PromoCodeController {
    ...
    public PromoCodeController(PromoCodeDao promoCodeDao, UserDao userDao) {
    ...
    @ResponseBody
    public ApiResponse<ArrayList<PromoCode>> promoCodes() {
    ...
    @ResponseBody
    public ApiResponse<PromoCode> promoCodes(@PathVariable UUID id) {
    ...
    @ResponseBody
    public ApiResponse<PromoCode> postPromoCodes(@RequestBody PromoCode promoCode) {
    ...
    @ResponseBody
    public ApiResponse<PromoCode> deletePromoCode(@PathVariable UUID id) {
        String email = (String) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        User user = userDao.findByEmail(email).get();
        if (!this.userDao.isUserAdmin(user)) {
    ...
    @ResponseBody
    public ApiResponse<PromoCode> togglePromoCodeStatus(@PathVariable UUID id, @RequestBody Map<String, Boolean> statusRequest) {
        String email = (String) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
